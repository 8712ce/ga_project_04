...
export default function Outcome() {
    ...
    return (
        <div className="body">
            <h1 className="main_text">You are devestated when your bullet hits its mark.  You collapse from the onset of insanity.  But don't be too sad.  Just have another baby in the zombie apocalypse!</h1>
